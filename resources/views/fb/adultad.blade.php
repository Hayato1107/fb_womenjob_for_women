...
<html>
    <head>
        ...
        <link href="{{ secure_asset('css/adultad.css') }}" rel="stylesheet">
    ...
    <body>
        ...
        <div class="big-body">
            ...
            <div class="body-top">
                ...
                <a href="./os"><img src="{{ asset('image/lp_ad_1.JPG') }}"></a>
                <h1><span>某有名アダルト掲示板のアプリ版</span></h1>
                <a href="./os" class="btn-square-shadow"><i class="fab fa-apple"></i> 最短1分で始める <i class="fas fa-external-link-alt"></i></a>
